...
Backbone.Syphon = (function(Backbone, $, _){
  ...
  var getForm = function(viewOrForm){
    if (_.isUndefined(viewOrForm.$el) &&
      (viewOrForm.tagName.toLowerCase() === 'form' || viewOrForm.tagName.toLowerCase() === 'fieldset')){
      return viewOrForm;
    } else {
      return viewOrForm.$el.is("form,fieldset") ? viewOrForm.el : viewOrForm.$("form,fieldset")[0];
    }
  };
